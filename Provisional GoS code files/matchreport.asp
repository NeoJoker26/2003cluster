		...
		if reportdate = "" then
				...
				for i = 0 to tablerows
  					...
  					if lowlist(i,0) = "" then
						...
						output = output & "<td" & cellstyle & "><a href=""matchreport1.asp?date=" & lowlist(i,0) & "&acknowledge=" & acknowledge & """>" & lowlist(i,1) & "</a></td>"
					...
					if highlist(i,0) = "" then
						...
						output = output & "<td" & cellstyle & "><a href=""matchreport1.asp?date=" & highlist(i,0) & "&acknowledge=" & acknowledge & """>" & highlist(i,1) & "</a></td>"
