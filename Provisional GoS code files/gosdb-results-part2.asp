...
sql = "select years, opposition, date, "
...
sql = sql & "where name_now = '" & fullteam & "' " & season_text 
...
Do While Not rs.EOF
	...
	outlinematch  = outlinematch & "<td class=""a" & topclass & """ nowrap=""nowrap"">" & displaydate & "<span id=""dtag" & tagno & """ style=""display:none;"">" & rs.Fields("date") & "</span></td>"	
	if rs.Fields("homeawayHA") = "H" then
		venue = "Home Park"
		if displaydate = "18 Mar 1961" then venue = "Plainmoor"
		outlinematch  = outlinematch & "<td class=""b" & topclass & """ align=""right"">" & "Argyle" & "</td>"   
		outlinematch  = outlinematch & "<td class=""c" & topclass & """ nowrap=""nowrap"">" & rs.Fields("goalsfor") & " - " & rs.Fields("goalsagainst") & "</td>" 
		outlinematch  = outlinematch & "<td class=""d" & topclass & """>" & opposition & "</td>"
		...
		outlinematch  = outlinematch & "<td class=""b" & topclass & """ align=""right"">" & opposition & "</td>"  
		outlinematch  = outlinematch & "<td class=""c" & topclass & """ nowrap=""nowrap"">" & rs.Fields("goalsagainst") & " - " & rs.Fields("goalsfor") & "</td>"
...
outline2  = outline2 & "<td class=""head""><a href=""#""><img hspace=""6"" border=""0"" src=""images/help.gif"" onclick=""showtip('Click on [+] to expand the details.<br>\\\'N\\\' indicates a special note.<br>\\\'R\\\' indicates a match report.')"" onmouseout=""hidetip()""></a></td>"
...
sql = sql & "from CTE2 "
sql = sql & "where name_now = '" & fullteam & "' "
