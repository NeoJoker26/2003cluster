...
<%
Dim conn,sql,rs, outline, heading, warning, bycolumn, bestworst, games, homeaway, homeawayclause1, homeawayclause2, orderby, selected_bycolumn(1), selected_bestworst(1), selected_games(30), selected_ha(2), thisseason, thisseasoncount
...
<%
 ...
 outline = outline & "<tr><td>Choose length of start (2-30 games; defaults to latest game if between 2 and 30):</td>"
 ...
 outline = outline & "<option value=""21"" " & selected_games(21) & ">21</option>"
 outline = outline & "<option value=""22"" " & selected_games(22) & ">22</option>" 
 outline = outline & "<option value=""23"" " & selected_games(23) & ">23</option>"
 outline = outline & "<option value=""24"" " & selected_games(24) & ">24</option>"
 outline = outline & "<option value=""25"" " & selected_games(25) & ">25</option>"
 outline = outline & "<option value=""26"" " & selected_games(26) & ">26</option>"
 outline = outline & "<option value=""27"" " & selected_games(27) & ">27</option>"
 outline = outline & "<option value=""28"" " & selected_games(28) & ">28</option>"
 outline = outline & "<option value=""29"" " & selected_games(29) & ">29</option>"
 outline = outline & "<option value=""30"" " & selected_games(30) & ">30</option>" 
 outline = outline & "</select></td></tr>"
