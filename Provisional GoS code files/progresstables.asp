  ...
  If table(n1,0) > "" then
	...
	Select case true
		case match_date > "" and match_date < "1976-07-01"
			...
			table(n1,43) = string(6-len(table(n1,13)),"0") & table(n1,13) & FormatNumber(table(n1,26),5,-1,0,0) & inverseteam 'follow points by GA, then club name
		case match_date > "" and match_date < "1992-07-01"
...
output = output & "<td colspan=""2"" style=""border-top: none; border-bottom: 2px solid #808080; border-right: 2px solid #808080; padding: 0 10px; text-align: center; font-weight: bold;"">" & headdate2
if frommatch = "" then
	output = output & "<br><ul>"  
